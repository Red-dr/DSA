...
public interface List<T> {
	 ...
	 */
	public abstract void addAt (T what, int where);
	
	/**
	 * Attempts to remove the element at the given key, 'sliding back' whatever is in front of it to replace it
	 * @param where the index to remove at (must be between 0 and the number of elements in this structure - 1)
	 */
	public abstract void removeAtKey (long where) throws Exception;
}
